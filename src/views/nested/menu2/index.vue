  ...
  <div class="app-container">
    ...
    <div class="head-container">
      <div style="margin-bottom: 20px;">      
        <el-descriptions title="列表11" direction="vertical" :column="4" border>
          <el-descriptions-item label="用户名">kooriookami</el-descriptions-item>
          <el-descriptions-item label="手机号">18100000000</el-descriptions-item>
          <el-descriptions-item label="居住地" :span="2">苏州市</el-descriptions-item>
          <el-descriptions-item label="备注">
            <el-tag size="small">学校</el-tag>
            <el-tag size="small" color="pink" style="margin-left: 10px;">公园</el-tag>
          </el-descriptions-item>
          <el-descriptions-item label="联系地址">地址</el-descriptions-item>
        </el-descriptions>
      </div>

      <el-radio-group v-model="labelPosition" size="small">
        <el-radio-button label="left">测试1</el-radio-button>
        <el-radio-button label="right">测试2</el-radio-button>
        <el-radio-button label="top">测试3</el-radio-button>
      </el-radio-group>
